...
extern "C" {
#endif
void  rmaPropagate0_sim_v1_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_sim_v1_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_p_sim_v1_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_sim_v1_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_wn_sim_v1_daidir (UB  * pcode, scalar  val);
